...
local assets = {
    StoicBombSpeedlines = "rbxassetid://88791656937416"
}

local KJAssets = Instance.new("Folder", game:GetService("RobloxReplicatedStorage"))
KJAssets.Name = "KJAssets"


for name, assetId in pairs(assets) do
    local obj = game:GetObjects(assetId)[1]
    obj.Parent = game:GetService("RobloxReplicatedStorage"):WaitForChild("KJAssets")
    obj.Name = name
end
...
local function stoic_bomb()
    ...
    -------------------< movement >---------------------
        ...
        local SpeedLines = game:GetService("RobloxReplicatedStorage").KJAssets.StoicBombSpeedlines:Clone()
        SpeedLines.Parent = game.Workspace
        SpeedLines.CFrame = CFrame.new(Vector3.new(0, -math.huge, 0))
        game:GetService("Debris"):AddItem(SpeedLines, 5)
        ...
        SpeedLines.CFrame = CFrame.new(Vector3.new(0, humanoidrootpart, 0))
        local weld = Instance.new("Weld")
        weld.Parent = workspace
        weld.Part0 = character:FindFirstChild("Left Leg")
    ...
    ---------------< general >-------------
        ...
        local connection2; connection2 = game:GetService("RunService").heartbeat:Connect(function()
            if not freezeVelo then
